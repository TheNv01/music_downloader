...
class ArcSeekBar@JvmOverloads constructor(
    ...
    var thumb: Drawable = a?.getDrawable(R.styleable.ArcSeekBar_thumb) ?: resources.getDrawable(R.drawable.ic_thumb_seek_bar)
        set(value) {
            field = a?.getDrawable(R.styleable.ArcSeekBar_thumb) ?: value
        }

    var alphaThumb: Int = 0
        set(value){
            thumb.alpha = value
            field = value
        }
